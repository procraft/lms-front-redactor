...
import { MonacoEditorCustomProps, modeMap } from './interfaces'
...
class FccEditor<
  P extends MonacoEditorCustomProps = MonacoEditorCustomProps
> extends PureComponent<P> {
  ...
  editorDidMount = (editor: any, monaco: any) => {
    ...
    editor.addAction({
      ...
      run: () => {
        // this.focusOnHotkeys()
        this.props.setEditorFocusability && this.props.setEditorFocusability(false)
      },
    })
    editor.addAction({
    ...
    editor.onDidFocusEditorWidget(() => {
      this.props.setEditorFocusability && this.props.setEditorFocusability(true)
    })
    ...
    const editableBoundaries: number[] = []

    // TODO Maybe need ot remove
